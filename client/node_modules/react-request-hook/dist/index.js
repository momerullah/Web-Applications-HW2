...
function useRequest(fn) {
    var axiosInstance = react.useContext(RequestContext);
    if (!axiosInstance) {
        throw new MissingProviderError();
    }
    var _a = react.useState([]), sources = _a[0], setSources = _a[1];
    ...
    var callFn = react.useRef(fn);
    react.useEffect(function () {
        callFn.current = fn;
    }, [fn]);
    var request$$1 = react.useCallback(function () {
        var args = [];
    ...
    var clear = react.useCallback(function (message) {
        if (sources.length > 0) {
    ...
    var clearRef = react.useRef(clear);
    react.useEffect(function () {
...
function useResource(fn, defaultParams) {
    ...
    var _c = react.useState(defaultParams), requestParams = _c[0], setRequestParams = _c[1];
...
exports.RequestConsumer = RequestConsumer;
